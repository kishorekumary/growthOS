...
export default function FitnessCoach() {
  ...
  return (
    <div className="flex flex-col h-[520px]">
      <h2 className="font-semibold text-white mb-4 shrink-0">Fitness Coach</h2>
        ...
        {messages.length === 0 && (
          <div className="space-y-4">
            <div className="flex flex-col items-center py-8 text-center">
              ...
              <p className="text-sm font-medium text-white">Your Fitness Coach</p>
              <p className="text-xs text-slate-500 mt-1">Ask anything about training, nutrition, or recovery.</p>
            </div>
